...
While the relay was designed with WireGuard in mind, it functions the same for **any type of UDP-based VPN tunnel**.  This can be used with WireGuard, AmeneziaWG (v1/v2), OpenVPN UDP, Hysteria2, etc.
